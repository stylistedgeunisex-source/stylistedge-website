...
const categoryDescriptions: Record<string, string> = {
  threading:
    "Precision shaping and threading to enhance your natural facial contours with absolute perfection.",
  waxing:
    "Silky smooth skin treatments utilizing premium waxes for long-lasting, gentle hair removal.",
  manicure:
    "Exquisite hand and feet therapies featuring nourishing botanical scrubs and flawless styling.",
  cleanup:
    "Revitalizing skin refreshment designed to cleanse pores and restore a vibrant, luminous glow.",
  facials:
    "Advanced facial treatments targeting specific skin needs for youthful rejuvenation and radiance.",
  spa: "Indulgent full-body massages and polish therapies to melt away stress and restore total harmony.",
  reflexology:
    "Targeted acupressure and neck therapies designed to stimulate energy flow and deep relaxation.",
  haircare:
    "Restorative scalp therapies and nourishing hair spa treatments to revive and strengthen every strand.",
  hairchemical:
    "High-end coloring, smoothing, and keratin treatments tailored to create your signature style.",
  clinical:
    "Dermatologically-inspired aesthetic therapies for targeted skin concerns and cellular renewal.",
  bridal:
    "Luxe occasion makeup and event styling packages to ensure you look breathtaking on your most special days.",
};
      ...
      return (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9.813 15.904L9 21l8.913-6.254m-8.913 0L3.72 10.225a3.375 3.375 0 00-1.005 2.534c0 1.258.696 2.404 1.8 3l5.297 3.145zM21 18a3 3 0 11-6 0 3 3 0 016 0z"
          />
        </svg>
      );
    case "facials":
      ...
      return (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9.53 16.122A3 3 0 00.47 18.242M20.312 18.242a3 3 0 01-9.06-2.12M12 9.75v-.75a3.75 3.75 0 00-7.5 0v.75m7.5 0H4.5M12 9.75v.75a3.75 3.75 0 01-7.5 0v-.75"
          />
        </svg>
      );
    case "hairchemical":
      return (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9.75 3.104v13.5m0-13.5L3.75 9.104h12l-6-6zM3.75 16.604h12v4.5h-12v-4.5z"
          />
        </svg>
      );
    case "clinical":
      ...
      return (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M11.48 3.499c.173-.427.768-.427.94 0l3.001 7.41 8.017.418c.463.024.648.59.294.905l-5.955 5.319 2.052 7.784c.12.455-.38.82-.767.585L12 19.347l-6.974 4.163c-.387.236-.887-.13-.767-.585l2.051-7.784-5.955-5.32c-.354-.314-.169-.88.294-.904l8.018-.418 3.001-7.41z"
          />
        </svg>
      );
  }
...
export default function HomePage() {
      ...
      return (
        <div className="flex flex-col sm:flex-row gap-2 text-right">
          <span className="inline-flex items-center justify-end text-xs text-text-muted">
            <span className="font-medium mr-1 text-[10px] uppercase tracking-wider bg-primary/5 text-primary px-1.5 py-0.5 rounded border border-primary/10">
              Male
            </span>
            <strong className="font-semibold text-primary text-sm">
              ₹{gender.male}
            </strong>
          </span>
          <span className="inline-flex items-center justify-end text-xs text-text-muted">
            <span className="font-medium mr-1 text-[10px] uppercase tracking-wider bg-accent/10 text-accent-light px-1.5 py-0.5 rounded border border-accent/20">
              Female
            </span>
            <strong className="font-semibold text-primary text-sm">
              ₹{gender.female}
  ...
  if (!db) {
    return (
      <div className="min-h-screen bg-bg-luxury flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="font-serif-luxury text-lg tracking-widest text-primary animate-pulse">
          Stylist Edge Salon
        </p>
  ...
  return (
    <div className="relative min-h-screen font-sans-luxury text-text-luxury selection:bg-accent/60 selection:text-primary overflow-x-hidden">
      ...
      <section ref={servicesRef} id="services" className="py-24 bg-bg-luxury">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest block mb-3">
              Our Offerings
            </span>
            ...
            <p className="text-text-muted text-sm md:text-base leading-relaxed">
              Unlock a world of sophisticated styling, skincare, and therapeutic
              pampering. Hover over each card to explore our bespoke services,
              and click to view pricing details.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {db.categories.map((category) => {
              const desc =
                ...
                "Experience custom-designed styling and premium body care tailored for you.";
                  ...
                  <div className="relative w-full h-full duration-700 preserve-3d group-hover:[transform:rotateY(180deg)] shadow-sm group-hover:shadow-xl rounded-xl border border-primary/5 transition-all">
                    ...
                    <div className="absolute inset-0 w-full h-full backface-hidden rounded-xl overflow-hidden bg-white">
                      ...
                      <div className="absolute bottom-0 left-0 w-full p-8 text-white z-20">
                        <span className="text-[10px] tracking-widest text-accent uppercase font-medium mb-1 block">
                          Luxury Service
                        </span>
            ...
            {activeCategory?.services && activeCategory.services.length > 0 ? (
              ...
              <div className="text-center py-20">
                <p className="font-serif-luxury text-lg text-text-muted italic">
                  New services are being curated. Please contact us for custom
                  packages.
                </p>
              </div>
            )}
      ...
      <section
        id="signature"
        className="py-24 bg-white border-y border-primary/5"
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          {/* Section title */}
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-text-muted text-sm md:text-base">
              A curated selection of our most highlighted treatment packages,
              handpicked to deliver unmatched indulgence and transformational
              beauty.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {signatureCategories.map((category) => {
              const desc =
                categoryDescriptions[category.id] ||
                "Indulge in a premium combination of our top-rated care regimens.";
              ...
              return (
                ...
                >
                  ...
                  <div className="p-8 flex-1 flex flex-col justify-between">
                    <div>
                      <span className="text-[10px] tracking-widest text-[#D4AF37] uppercase font-bold mb-1.5 block">
                        Exclusive Offering
                      </span>
            ...
            <div className="lg:col-span-7 space-y-6 lg:pl-6">
              ...
              <div className="space-y-4 text-text-muted font-light leading-relaxed text-sm md:text-base">
                <p>
                  ...
                  , we believe that style is a language that speaks of your
                  identity and confidence. Nestled in the heart of Dharmapuri,
                  our unisex salon offers a sanctuary of refined luxury,
                  pristine aesthetics, and masterfully crafted personal care
                ...
                <p>
                  ...
                  , the brand is built upon an unwavering standard of
                  excellence. Whether you visit us for precision threading,
                  skin-refreshing cleanups, specialized hair treatments, or
                  occasion styling, you enter a space dedicated entirely to your
                ...
                <p className="italic font-serif-luxury text-primary border-l-2 border-accent pl-4 text-base my-6">
                  &ldquo;We do not merely change hairstyles or perform skincare;
                  we elevate your innate self-assurance, designing experiences
                  that let your unique style radiate with absolute
                  conviction.&rdquo;
                </p>
                <p>
                  Our services are entirely personalized. We merge premium salon
                  products, contemporary artistic technique, and deep-care
                  clinical treatments to ensure each visit feels restorative,
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-bg-luxury rounded-2xl border border-primary/5 hover:border-accent/30 transition-all duration-300 text-center flex flex-col items-center">
              ...
              <span className="text-[10px] tracking-widest text-accent uppercase font-bold mb-1">
                Director & Stylist
              </span>
              ...
              <p className="text-xs text-text-muted">
                Personalized beauty consulting and execution specialist.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-xs text-text-muted group-hover:underline">
                Click to call and book your priority appointment.
              </p>
            </a>
      ...
      <footer className="bg-primary text-white pt-16 pb-8 border-t border-accent/20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-white/70 max-w-xs font-light tracking-wide leading-relaxed">
              Premium unisex luxury and personalized styling curation designed
              to make everyone feel confident, refreshed, and uniquely
              themselves.
            </p>
          </div>
          ...
          <div className="space-y-4 text-sm">
            <h4 className="font-serif-luxury text-lg font-medium text-accent">
              Menu
            </h4>
            <div className="grid grid-cols-2 gap-2 text-xs text-white/75 font-light">
              <a href="#services" className="hover:text-accent hover:underline">
                Services Catalogue
              </a>
              <a
                href="#signature"
              ...
              <a href="#about" className="hover:text-accent hover:underline">
                About Edge
              </a>
              <a href="#contact" className="hover:text-accent hover:underline">
                Connect/Find Us
              </a>
            </div>
            ...
            <div className="pt-3 border-t border-white/10">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs text-white/75 font-light mt-2">
                <a
                  href="/privacy-policy"
                  className="hover:text-accent hover:underline"
                >
          ...
          <div className="space-y-4 text-xs text-white/75 font-light">
            ...
            <p className="flex items-center gap-2">
              <span className="text-accent font-semibold">Head:</span>{" "}
              {db.brand.contact.person}
            </p>
            <p className="flex items-center gap-2">
              <span className="text-accent font-semibold">Phone:</span> +91{" "}
              {db.brand.contact.phone}
            </p>
            <p className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] text-white/50 tracking-wider uppercase">
          <p>
            © {new Date().getFullYear()} {db.brand.name}. All Rights Reserved.
          </p>
          <p className="mt-2 md:mt-0">
            Design & Curation by {db.brand.contact.person}
          </p>
        </div>
      </footer>
